# CodeBuddy Code | 从自定义状态行开始，开启你的个性化编码旅程!

> 公众号: 腾讯CodeBuddy
> 发布时间: 2025-12-02 09:01
> 原文链接: https://mp.weixin.qq.com/s/mFfDqzgRLNoDLWWhI0EJag
...
想让 CodeBuddy Code 的开发助手界面更贴合你的工作习惯吗？本文详细介绍了如何通过自定义状态行，在界面底部实时展示你所需的上下文信息。通过自定义状态行让 CodeBuddy Code 更具个性化,其工作方式灵活，就如Oh-my-zsh 等 shell 中的终端提示符(PS1)，让一切重要信息一目了然。
...
GIT_BRANCH=""
if git rev-parse --git-dir > /dev/null2>&1; then
...
- CLI 官方文档 : https://copilot.tencent.com/cli/

🚀立即动手，创作您的专属状态行，让 CodeBuddy Code 更符合您的工作风格!
...
![Image](images/img_003.jpeg)![Image](images/img_004.jpeg)![Image](images/img_005.jpeg)